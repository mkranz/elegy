<template>
  ...
  <q-list padding>
    <!-- Adventure Moves -->
    <q-expansion-item group="moves" icon="casino" label="Adventure Moves" default-closed elevated
      header-class="text-primary">
      <!-- Face Danger -->
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          <div class="text-h6">Face Danger</div>
          <p>When you attempt something risky or react to an imminent threat, envision your action and roll. If you
            act...</p>

          <div class="q-gutter-y-sm">
            <div>With stealth, speed, or coordination:
              <StatRoll statName="dexterity" moveName="Face Danger" :outcomes="faceDangerOutcomes" />
            </div>
            <div>With courage, willpower, or empathy:
              <StatRoll statName="heart" moveName="Face Danger" :outcomes="faceDangerOutcomes" />
            </div>
            <div>With aggression, strength, or toughness:
              <StatRoll statName="force" moveName="Face Danger" :outcomes="faceDangerOutcomes" />
            </div>
            <div>With charm, composure, or manipulation:
              <StatRoll statName="glamour" moveName="Face Danger" :outcomes="faceDangerOutcomes" />
            </div>
            <div>With expertise, focus, or observation:
              <StatRoll statName="intellect" moveName="Face Danger" :outcomes="faceDangerOutcomes" />
            </div>
          </div>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you assess a situation, make preparations, or attempt to gain leverage, envision your action and roll.
            If you act...</p>

          <div class="q-gutter-y-sm">
            <div>With stealth, speed, or coordination:
              <StatRoll statName="dexterity" moveName="Secure An Advantage" :outcomes="secureAdvantageOutcomes" />
            </div>
            <div>With courage, willpower, or empathy:
              <StatRoll statName="heart" moveName="Secure An Advantage" :outcomes="secureAdvantageOutcomes" />
            </div>
            <div>With aggression, strength, or toughness:
              <StatRoll statName="force" moveName="Secure An Advantage" :outcomes="secureAdvantageOutcomes" />
            </div>
            <div>With charm, composure, or manipulation:
              <StatRoll statName="glamour" moveName="Secure An Advantage" :outcomes="secureAdvantageOutcomes" />
            </div>
            <div>With expertise, focus, or observation:
              <StatRoll statName="intellect" moveName="Secure An Advantage" :outcomes="secureAdvantageOutcomes" />
            </div>
          </div>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you search for clues, conduct an investigation, analyze evidence, or do research,
            <StatRoll statName="intellect" moveName="Gather Information" :outcomes="gatherInformationOutcomes" />
          </p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you Secure an Advantage in direct support of an ally and score a hit, they (instead of you) can take
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <div class="q-gutter-y-sm">
            <div>Charm or lie:
              <StatRoll statName="glamour" moveName="Compel" :outcomes="compelOutcomes" />
            </div>
            <div>Threaten or incite:
              <StatRoll statName="force" moveName="Compel" :outcomes="compelOutcomes" />
            </div>
            <div>Pacify or encourage:
              <StatRoll statName="heart" moveName="Compel" :outcomes="compelOutcomes" />
            </div>
          </div>
    ...
    <!-- Power Moves -->
    <q-expansion-item group="moves" icon="auto_fix_high" label="Power Moves" default-closed header-class="text-primary">
      <!-- Use Power -->
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          <div class="text-h6">Use Power</div>
          <p>When you use your supernatural abilities to activate a power, visualize the effects you want to manifest
            and roll the stat indicated in its asset card; if you use them to appear human for a scene (blushing, being
            able to have sex or consume food),
            <StatRoll statName="glamour" moveName="Use Power" :outcomes="usePowerOutcomes" />
          </p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you perform a ritual of blood magic, envision what to want to achieve and how you perform it. Then,
            <StatRoll statName="intellect" moveName="Perform Ritual" :outcomes="performRitualOutcomes" />
          </p>
    ...
    <!-- Downtime Moves -->
    <q-expansion-item group="moves" icon="nightlight" label="Downtime Moves" default-closed header-class="text-primary">
      <!-- Rest -->
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          <div class="text-h6">Rest</div>
          <p>When you spend the whole daytime in deep sleep in a dark place,
            <StatRoll statName="heart" moveName="Rest" :outcomes="restOutcomes" />
            or
            <StatRoll statName="intellect" moveName="Rest" :outcomes="restOutcomes" />, whichever is higher.
          </p>

          <p>By default, you need the Lair asset to have access to a secure place to sleep you can call yours. If you
            don't have it, you must sleep in abandoned places.</p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you focus on your skills, receive training, find inspiration or earn a reward, you may spend 3 xp to
            add a new asset, or 2 xp to upgrade one. The chosen asset must be framed within fiction and make sense in
            the context.</p>
        </q-card-section>
      </q-card>
    </q-expansion-item>
    ...
    <!-- Combat Moves -->
    <q-expansion-item group="moves" icon="sports_kabaddi" label="Combat Moves" default-closed
      header-class="text-primary">
      <!-- Enter The Fray -->
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          <div class="text-h6">Enter The Fray</div>
          <p>When you initiate combat or are forced into a fight, envision your objective and give it a rank. If the
            combat includes discrete challenges or phases, set an objective with a rank for each. Then, roll to see if
            you are in control. If you are...</p>

          <div class="q-gutter-y-sm">
            <div>Facing off against your foe:
              <StatRoll statName="heart" moveName="Enter The Fray" :outcomes="enterTheFrayOutcomes" />
            </div>
            <div>In the thick of it at close quarters:
              <StatRoll statName="force" moveName="Enter The Fray" :outcomes="enterTheFrayOutcomes" />
            </div>
            <div>On the move or preparing to act against an unaware foe:
              <StatRoll statName="dexterity" moveName="Enter The Fray" :outcomes="enterTheFrayOutcomes" />
            </div>
            <div>Caught in a trap or sizing up the situation:
              <StatRoll statName="intellect" moveName="Enter The Fray" :outcomes="enterTheFrayOutcomes" />
            </div>
          </div>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you fight against a foe at close quarters,
            <StatRoll statName="force" moveName="Clash" :outcomes="clashOutcomes" />; when you exchange fire at a
            distance,
            <StatRoll statName="dexterity" moveName="Clash" :outcomes="clashOutcomes" />.
          </p>

          <p>On a <strong>strong hit</strong>, mark progress twice. You overwhelm your foe.</p>
          <p>On a <strong>weak hit</strong>, mark progress, but you are dealt a counterblow or setback. Pay the Price.
          </p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you make a move to take decisive action, roll the challenge dice and compare to your progress. Focus
            is ignored on this roll.</p>
          <StatRoll statName="force" moveName="End The Fight" :outcomes="endTheFightOutcomes" />
        </q-card-section>
      </q-card>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you fight a battle, and it happens in a blur, envision your objective and roll. If you primarily...
          </p>

          <div class="q-gutter-y-sm">
            <div>Fight at range or using your speed or trickery to your advantage:
              <StatRoll statName="dexterity" moveName="Battle" :outcomes="battleOutcomes" />
            </div>
            <div>Fight depending on your courage, leadership, or companions:
              <StatRoll statName="heart" moveName="Battle" :outcomes="battleOutcomes" />
            </div>
            <div>Fight in close to overpower your foe:
              <StatRoll statName="force" moveName="Battle" :outcomes="battleOutcomes" />
            </div>
            <div>Fight using careful tactics to outsmart your foe:
              <StatRoll statName="intellect" moveName="Battle" :outcomes="battleOutcomes" />
            </div>
          </div>

          <p>On a <strong>strong hit</strong>, you achieve your objective unconditionally. You and any allies who joined
            the battle may take +2 focus.</p>
    ...
    <!-- Connection Moves -->
    <q-expansion-item group="moves" icon="people" label="Connection Moves" default-closed header-class="text-primary">
      <!-- Make A Connection -->
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          <div class="text-h6">Make A Connection</div>
          <p>When you search out a new relationship or give focus to an existing relationship (not an ally or
            companion),
            <StatRoll statName="heart" moveName="Make A Connection" :outcomes="makeConnectionOutcomes" />
          </p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When your relationship with a connection is tested through conflict, betrayal, or circumstance,
            <StatRoll statName="heart" moveName="Test Your Relationship" :outcomes="testRelationshipOutcomes" />. If you
            share a bond, add +1.
          </p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When your connection with someone is ready to evolve,
            <StatRoll statName="heart" moveName="Form A Bond" :outcomes="formBondOutcomes" />
          </p>
    ...
    <!-- Suffer Moves -->
    <q-expansion-item group="moves" icon="warning" label="Suffer Moves" default-closed header-class="text-primary">
      <!-- Pay The Price -->
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <div class="q-mt-md">
            <q-btn color="primary" label="Roll on the table" @click="payThePrice" />
          </div>
        </q-card-section>
      </q-card>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <ul>
            <li>Exchange each additional -focus for any combination of -health, -spirit, or -blood as appropriate to the
              circumstances.</li>
            <li>Envision an event or discovery which undermines your progress in a current quest, journey, or fight.
              Then, for each additional -focus, clear 1 unit of progress on that track per its rank (troublesome=clear 3
              progress; dangerous=clear 2 progress; formidable=clear 1 progress; extreme=clear 2 ticks; epic=clear 1
              tick).</li>
          </ul>
        </q-card-section>
      </q-card>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you face physical damage, suffer -health equal to your foe's rank or as appropriate to the situation.
            If your health is 0, suffer -focus equal to any remaining -health. Then,
            <StatRoll statName="force" moveName="Endure Harm" :outcomes="endureHarmOutcomes" />
          </p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you are brought to the brink of your annihilation, and glimpse the world beyond,
            <StatRoll statName="heart" moveName="Face Last Death" :outcomes="faceLastDeathOutcomes" />
          </p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you use supernatural powers or spend blood as a result of the Pay the Price move, suffer -blood as
            appropriate to the situation. If your blood is 0, suffer -focus equal to any remaining -focus. Then,
            <StatRoll statName="intellect" moveName="Endure Hunger" :outcomes="endureHungerOutcomes" />
          </p>
          ...
          <p>On a <strong>miss</strong>, also suffer -1 focus. If you are at 0 blood, you must mark starving or sinner
            (if currently unmarked) or roll on the following table:</p>

          <div class="text-caption q-gutter-y-sm">
            <p>1-10: Your hunger consumes you. Face Starvation.</p>
            <p>11-25: You are on the brink of starvation. You need to Feed within an hour or two, or Face Last Death.
            </p>
            <p>26-50: You are unconscious and out of action. If left alone, you come back to your senses in an hour or
              two. If you are vulnerable to a foe not inclined to show mercy, Face Last Death.</p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you are brought to the brink of starvation,
            <StatRoll statName="intellect" moveName="Face Starvation" :outcomes="faceStarvationOutcomes" />
          </p>

          <p>On a <strong>strong hit</strong>, you resist and press on.</p>
          <p>On a <strong>weak hit</strong>, pick one:</p>
          <ul>
            <li>Your humanity is devoured, but not before remembering a moment of your mortal life. Envision what
              flashes behind your eyes.</li>
            <li>You get so frenzied, you commit something that angers your ruler. Envision what it is. She'll ask
              something in return of letting you live. When she does, envision the frightening encounter and Sing an
              Elegy to her (formidable or extreme).</li>
          </ul>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you face mental shock or despair, suffer -spirit equal to your foe's rank or as appropriate to the
            situation. If your spirit is 0, suffer -focus equal to any remaining -spirit. Then,
            <StatRoll statName="heart" moveName="Endure Stress" :outcomes="endureStressOutcomes" />
          </p>
          ...
          <p>On a <strong>weak hit</strong>, you press on.</p>
          <p>On a <strong>miss</strong>, also suffer -1 focus. If you are at 0 spirit, you must mark shaken or corrupted
            (if currently unmarked) or roll on the following table:</p>
      ...
      <q-card flat bordered class="q-mb-md">
        <q-card-section>
          ...
          <p>When you are brought to the brink of desolation,
            <StatRoll statName="heart" moveName="Face Desolation" :outcomes="faceDesolationOutcomes" />
          </p>

          <p>On a <strong>strong hit</strong>, you resist and press on.</p>
          <p>On a <strong>weak hit</strong>, choose one:</p>
          <ul>
            <li>Your spirit or sanity breaks, but not before you make a noble sacrifice. Envision your final moments.
            </li>
            <li>You see a vision of a dreaded event coming to pass. Envision that dark future, and Sing an Elegy
              (formidable or extreme) to prevent it. If you fail to score a hit when you Sing an Elegy, or refuse the
              quest, you are lost. Otherwise, you return to your senses and are now tormented. You may only clear the
              tormented debility by completing the quest.</li>
          </ul>
